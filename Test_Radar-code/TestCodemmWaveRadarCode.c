...
void setup(void)
{
    ...
    if (isRadarEnabled) {
        ...
        // Short delay to allow the sensor to be ready for commands
        delay(500);
        
        // Set gates ONLY NOW, since the radar is initialized
        ...
        // Manually read the configuration since we blocked it during boot
